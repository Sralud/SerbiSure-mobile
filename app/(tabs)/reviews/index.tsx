...
export default function ReviewsScreen() {
  ...
  const reviews = settings.mockDataEnabled ? REVIEWS : [];
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          All recent reviews from your completed jobs
        </Text>
      </View>
      ...
      <Card style={styles.card}>
        {reviews.length > 0 ? (
          ...
          <Text style={styles.emptyReviewText}>
            No reviews yet. Enable Mock Data in Settings to see sample reviews.
          </Text>
        )}
      </Card>
    </ScrollView>
